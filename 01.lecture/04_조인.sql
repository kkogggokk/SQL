...
from emp e, dept d 
where e.dept_id = d.dept_id and e.job_id = 'FI_ACCOUNT'
order by 1;
...
select e.emp_id, e.emp_name, e.salary, e.comm_pct, d.dept_name, d.loc
from emp e, dept d 
where e.dept_id = d.dept_id and e.comm_pct is not null
order by 1;
...
select d.dept_id, d.dept_name, d.loc, e.emp_id, e.emp_name,e.job_id
from dept d, emp e 
where d.dept_id = e.dept_id and d.loc='New York'
order by 1;
...
select e.emp_id, e.emp_name, e.salary, j.job_title, d.dept_name
from emp e, job j, dept d 
where e.dept_id = d.dept_id and e.job_id = j.job_id and e.emp_id = 200;
...
where d.dept_id = e.dept_id and e.job_id = j.job_id and d.dept_name = 'Shipping'
order by 3 desc;
...
from emp e, dept d 
where e.dept_id = d.dept_id and d.loc = 'San Francisco';


--TODO 부서별 급여(salary)의 평균을 조회. 부서이름(dept.dept_name)과 급여평균을 출력. 급여 평균이 높은 순서로 정렬.
-- 급여는 , 단위구분자와 $ 를 붙여 출력.
-- result : 11 
select d.dept_name, to_char(round(avg(e.salary),2),'$999,999') 급여평균
from dept d, emp e 
...
where e.dept_id = d.dept_id and e.job_id = j.job_id and e.salary between s.low_sal and s.high_sal
...
where e.dept_id = d.dept_id and e.salary between s.low_sal and s.high_sal and s.grade = 1 
group by d.dept_name, d.dept_id 
order by 2 desc;
